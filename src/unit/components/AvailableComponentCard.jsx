...
export const AvailableComponentCard = ({ label, icon, navigate, category, type, onSuccess, onError }) => {
  ...
  return <Button variant='outline-dark' size="lg" className='flex-c-1 bg-white border-none rounded-c-lg justify-content-between' iconBefore={icon} onClick={handleCreate} disabled={isCreating}>
